...
class Building implements CarbonFootprint {
    ...
    public double getCarbonFootprint() {
        // Calculate carbon footprint of the building based on its energy consumption
...
class Car implements CarbonFootprint {
    ...
    @Override
    public double getCarbonFootprint() {
        // Calculate carbon footprint of the car based on its fuel consumption
...
class Bicycle implements CarbonFootprint {
    ...
    @Override
    public double getCarbonFootprint() {
        // Bicycles have no carbon footprint as they do not consume any fuel
        return 0.0;
    }
...
public class Main {
    ...
    // Get input from user for Building object
    ...
    // Get input from user for Bicycle object
