...
public class Test {
    ...
    public static void main(String[] args) {
        // get input from user for employee1
        ...
        // create employee4 object using user input
